    ...
    while (!ctx->done)
    {
         ...
         else if (event & NETWORK_DATA)
        {
            ...
            if (is_FIN(recv_segment->header.th_flags) && ctx->connection_state == CSTATE_ESTABLISHED) {
                ...
                fprintf(stderr,"ESTABLISHED -> CLOSE_WAIT\n");
            }
